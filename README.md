...
> 국립국어원이 "-노"의 대표 용법을 의문사가 있는 의문문으로만 기술하고 있고, 실제 경상도 방언을 기술한 연구에서 무섭노? 는 일반적인 판정 의문형이라는 객관적인 근거는 확인되지 않았습니다.
> 따라서 리센느 정원이를 감정적으로 대변할수 있으나, 감정이 감정이고 일베의 은어 맥락 과 국립어학원의 정의 등 객관적인 기준에서 잘못은 잘못임을 분별력 있게 사리판단 하는것이 올바른 시각입니다.
